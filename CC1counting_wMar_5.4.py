...
#Adapted layers based on the following artical for actin cytostructural differences
#https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0213626
model.add(layers.Conv2D(32, (3,3), activation='relu', input_shape=(46,46,3)))
model.add(layers.MaxPooling2D((2,2)))
model.add(layers.Conv2D(64, (3,3), activation='relu'))
model.add(layers.MaxPooling2D((2,2)))
model.add(layers.Conv2D(46, (3,3), activation='relu'))
model.add(layers.MaxPooling2D((2,2)))
model.add(layers.Conv2D(46, (3,3), activation='relu'))
model.add(layers.MaxPooling2D((2,2)))
...
import os
#change paths
train_dir = 'GammaCorrected0_5/train'
validation_dir = 'GammaCorrected0_5/validation'
test_dir = 'GammaCorrected0_5/test'
...
analysis_name = 'CC1counting_wMar_5.4'
